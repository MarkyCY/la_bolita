...
for num_simb in charada:
    num, simbolos = num_simb.split(".")
    num = int(num)
    simbolos_list = [s.strip() for s in simbolos.split(",")]
    charada_json["charadas"].append({
        "numero": num,
        "simbolos": simbolos_list
    })

with open("charadas.json", "w") as f:
    json.dump(charada_json, f, indent=4)